...
def scaffold_split(
    ...
    """
    Adapted from github.com/deepchem/deepchem/blob/master/deepchem/splits/splitters.py
    ...
    if task_idx is not None:
        ...
        non_null = y_task is not null_value
...
def random_scaffold_split(
    ...
    https://github.com/pfnet-research/chainer-chemistry/blob/master/chainer_chemistry/\
    dataset/splitters/scaffold_splitter.py
...
def random_split(
    ...
    :return: train, valid, test slices of the input dataset obj. If
    smiles_list is not None, also returns ([train_smiles_list],
    [valid_smiles_list], [test_smiles_list])
    """
    np.testing.assert_almost_equal(frac_train + frac_valid + frac_test, 1.0)
